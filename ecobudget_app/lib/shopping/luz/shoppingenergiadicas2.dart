    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          bordaamarela(
              110,
              '\nO dimensionamento da iluminação artificial, quando bem realizado, pode reduzir consideravelmente a necessidade de lâmpadas em um ambiente, evitando assim o desperdício de energia.',
              15),
          bordaamarela(
              110,
              ' \nPara reduzir a necessidade elevada de resfriamento em locais de alta lotação, sistemas de recuperação de calor e climatizadores evaporativos são alternativas viáveis a serem utilizadas',
              15),
        ],
      ),
    );
