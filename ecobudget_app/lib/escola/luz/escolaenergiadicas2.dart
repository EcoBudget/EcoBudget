    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          bordaamarela(110,'\nInstalar sensores de presença que ativam as luzes do banheiro e/ou de outros locais. Dessa forma não há a possibilidade de deixar acesas luzes que não estão sendo utilizadas.' , 15),
          tituloformatado(19,'Manutenção' , 'Segoe UI'),
          bordaamarela(70,'\nRealizar a manutenção da rede elétrica de modo a evitar curtos circuitos na rede.' , 15),
